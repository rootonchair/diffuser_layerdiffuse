...
DEFAULT_WEIGHT_NAME = "diffuser_layer_xl_transparent_conv.safetensors"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate SDXL transparent foreground images with conv deltas.")
    ...
    parser.add_argument("--negative-prompt", default="bad quality, distorted")
    parser.add_argument("--output", default="result_conv_sdxl.png")
