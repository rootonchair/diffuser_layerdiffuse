...
DEFAULT_WEIGHT_NAME = "layer_sd15_joint.safetensors"
DEFAULT_TRANSPARENT_DECODER_NAME = "layer_sd15_vae_transparent_decoder.safetensors"


def parse_args():
    parser = argparse.ArgumentParser(description="Generate SD1.5 foreground, background, and blend images together.")
    ...
    parser.add_argument(
        "--outputs",
        nargs="+",
        default=["result_joint_0.png", "result_joint_1.png", "result_joint_2.png"],
    )
...
def load_pipeline(args):
    ...
    transparent_vae.set_transparent_decoder(load_file(str(decoder_path)), mod_number=3)
...
if __name__ == "__main__":
    ...
    load_lora_to_unet(pipeline.unet, weight_path, frames=3)
